  ...
  <header :class="{'blurred-background': getSideNav === true}" >
    <div class="header-logo">
      <a @click=redirectToHome>
        <img src="https://d3s87pah5oatx.cloudfront.net/uploads/3c23e6e5-1388-4b38-98c6-7db2f600f661/original/C1_LOGO_PRIMARY_BLUE_RED_CMYK_NOREG_1.svg" alt="Capital One" class="dynamic-bank-logo" />
      </a>
      <img
