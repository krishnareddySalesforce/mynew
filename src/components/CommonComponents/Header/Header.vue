  ...
  <header :class="{'blurred-background': getSideNav === true}" >
    <div class="header-logo">
      <a @click=redirectToHome>
        <img src="https://d3s87pah5oatx.cloudfront.net/uploads/5d713bc6-fa86-4373-83e5-272162e217e4/original/vanquis-logo-desktop-blue.png" alt="VANQUIS" class="dynamic-bank-logo" />
      </a>
      <img
